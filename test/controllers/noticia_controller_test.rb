...
class NoticiaControllerTest < ActionController::TestCase
  ...
  test "should create noticium" do
    assert_difference('Noticium.count') do
      post :create, noticium: { description: @noticium.description, name: @noticium.name, picture: @noticium.picture }
    end
  ...
  test "should update noticium" do
    patch :update, id: @noticium, noticium: { description: @noticium.description, name: @noticium.name, picture: @noticium.picture }
    assert_redirected_to noticium_path(assigns(:noticium))
  end
